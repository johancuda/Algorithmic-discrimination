...
st.subheader("Informazioni sui sistemi automatici in Svizzera")
...
st.subheader("A proposito di FOTRES")
...
st.subheader("A proposito di COMPAS")
...
st.subheader("A proposito di FaST")
